...
export default function CreateOrganizationPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setTimeout(() => {
        router.push("/admin/world-data/organizations/manage")
      }, 1500)
    } catch (error) {
    ...
    <div className="min-h-screen bg-gray-100">
      <header className="bg-white shadow">
        <div className="max-w-4xl mx-auto px-4 py-4 flex items-center gap-4">
          ...
          <h1 className="text-xl font-bold text-teal-600">Create New Organization</h1>
        </div>
      </header>
        ...
        <div className="bg-white rounded-lg shadow p-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  placeholder="e.g., Pacific Pictures"
                />
              </div>
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 mt-1">Only unlinked organization articles are shown</p>
            </div>

            <button
              type="submit"
              disabled={saving}
              className="w-full bg-teal-600 hover:bg-teal-700 text-white font-medium py-2 px-4 rounded disabled:opacity-50 disabled:cursor-not-allowed"
            >
