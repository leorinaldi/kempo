...
export default function ManageSeriesPage() {
  ...
  return (
    <AdminPageLayout title="Manage Series" backHref="/admin/world-data/video/series" color="green">
      ...
      <DeleteConfirmModal
        ...
        isDeleting={deleting}
        warningMessage={
          deleteModal && deleteModal._count.episodes > 0
            ? `This series has ${deleteModal._count.episodes} episodes that will be unlinked.`
            : undefined
        }
      />
    </AdminPageLayout>
