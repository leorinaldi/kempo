    ...
    <div className="min-h-screen bg-gray-100">
      <header className="bg-white shadow">
        <div className="max-w-4xl mx-auto px-4 py-4 flex justify-between items-center">
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-xl font-bold text-orange-600">Brands</h1>
          </div>
          <div className="flex items-center gap-4">
      ...
      <main className="max-w-4xl mx-auto px-4 py-12">
        <div className="grid md:grid-cols-2 gap-8">
          {/* Create New Brand */}
          <Link
            href="/admin/world-data/brands/create"
          ...
          >
            <div className="flex flex-col items-center text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-800 mb-2">Create New Brand</h3>
              <p className="text-gray-600 text-sm">
                Add a new brand to the Kempo universe
              </p>
            </div>
          </Link>
          ...
          {/* Manage Brands */}
          <Link
            href="/admin/world-data/brands/manage"
            className="bg-white rounded-xl shadow-lg p-8 hover:shadow-xl transition-shadow border-2 border-transparent hover:border-orange-400 group"
          >
            <div className="flex flex-col items-center text-center">
              <div className="w-20 h-20 bg-orange-100 rounded-full flex items-center justify-center mb-4 group-hover:bg-orange-200 transition-colors">
              ...
              <h3 className="text-xl font-semibold text-gray-800 mb-2">Manage Brands</h3>
              <p className="text-gray-600 text-sm">
                View, edit, and delete existing brands
              </p>
            </div>
          </Link>
        </div>
