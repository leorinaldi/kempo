  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <main className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="mb-12">
          <h2 className="text-lg font-semibold text-gray-500 uppercase tracking-wide mb-6">Manage Media</h2>
          <div className="grid md:grid-cols-4 gap-6">
            ...
            >
              <div className="flex flex-col items-center text-center">
                <div className="w-20 h-20 bg-amber-100 rounded-full flex items-center justify-center mb-4 group-hover:bg-amber-200 transition-colors">
                  <svg className="w-10 h-10 text-amber-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19V6l12-3v13M9 19c0 1.105-1.343 2-3 2s-3-.895-3-2 1.343-2 3-2 3 .895 3 2zm12-3c0 1.105-1.343 2-3 2s-3-.895-3-2 1.343-2 3-2 3 .895 3 2zM9 10l12-3" />
                  </svg>
                </div>
                <h3 className="text-xl font-semibold text-gray-800 mb-2">Audio</h3>
                <p className="text-gray-600 text-sm">
                  Upload songs, manage the Kempo Radio playlist, and organize your audio library
                </p>
            ...
            >
              <div className="flex flex-col items-center text-center">
                ...
                <h3 className="text-xl font-semibold text-gray-800 mb-2">Video</h3>
                <p className="text-gray-600 text-sm">
                  Upload clips, manage the Kempo TV playlist, and organize your video library
                </p>
            ...
            {/* Publications Card */}
            <Link
              href="/admin/world-data/publications"
              className="bg-white rounded-xl shadow-lg p-8 hover:shadow-xl transition-shadow border-2 border-transparent hover:border-cyan-400 group"
            >
              <div className="flex flex-col items-center text-center">
                <div className="w-20 h-20 bg-cyan-100 rounded-full flex items-center justify-center mb-4 group-hover:bg-cyan-200 transition-colors">
                ...
                <p className="text-gray-600 text-sm">
                  Manage newspapers, magazines, comic books, and books
                </p>
        ...
        <div className="mb-12">
          ...
          <div className="grid md:grid-cols-4 gap-6">
            ...
            {/* Organizations Card */}
            <Link
              href="/admin/world-data/organizations"
              className="bg-white rounded-xl shadow-lg p-8 hover:shadow-xl transition-shadow border-2 border-transparent hover:border-teal-400 group"
            >
              <div className="flex flex-col items-center text-center">
                ...
                <h3 className="text-xl font-semibold text-gray-800 mb-2">Organizations</h3>
                <p className="text-gray-600 text-sm">
                  Create and manage organizations in the Kempo universe
                </p>
            ...
            {/* Locations Card */}
            <Link
              href="/admin/world-data/locations"
              className="bg-white rounded-xl shadow-lg p-8 hover:shadow-xl transition-shadow border-2 border-transparent hover:border-emerald-400 group"
            >
              <div className="flex flex-col items-center text-center">
                ...
                <p className="text-gray-600 text-sm">
                  Manage nations, states, cities, and places
                </p>
        ...
        <div className="mb-12">
          <h2 className="text-lg font-semibold text-gray-500 uppercase tracking-wide mb-6">Manage Events</h2>
          <div className="grid md:grid-cols-4 gap-6">
            {/* Events Card */}
            <Link
              href="/admin/world-data/events"
            ...
            >
              <div className="flex flex-col items-center text-center">
                ...
                <p className="text-gray-600 text-sm">
                  Timeline events, hierarchy browser, and cross-classification
                </p>
