      ...
      <main className="max-w-4xl mx-auto px-4 py-8">
        <div className="bg-white rounded-lg shadow p-6 mb-6">
          ...
          <p className="text-sm text-gray-600 mb-6">
            These documents guide the advancement of the Kempo simulation. They are ordered by their role in the
            simulation advancement process, with the overall methodology at the top.
          </p>
