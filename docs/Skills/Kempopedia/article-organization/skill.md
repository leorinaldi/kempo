...
- **military-academy**: Training institutions (e.g., American Military Academy)
...
|-------|-------------|-------|
| Official_name | **Required** | Full legal/official name |
| Type | **Required** | Maps to DB `orgType` field |
| Founded | Recommended | Include when known |
| Location | Recommended | Headquarters location |
| Abbreviation | Optional | When commonly used |
| Motto | Optional | When applicable |
| Colors | Optional | For schools, sports teams |
