...
|-------|-------------|-------|
| Full_name | **Required** | Complete legal name |
| Nationality | **Required** | For context |
| Occupation | **Required** | Defines the person |
| Birth_date | Recommended | Include when known |
| Birth_place | Recommended | Include when known |
| Death_date | Conditional | Only if deceased |
| Death_place | Conditional | Only if deceased |
| Education | Optional | When relevant |
| Political_party | Optional | For politicians |
| Spouse | Optional | When notable |
| Children | Optional | When relevant |
| Military_service | Optional | For military figures |
| Rank | Optional | For military figures |
| Known_for | Optional | Key achievements |
