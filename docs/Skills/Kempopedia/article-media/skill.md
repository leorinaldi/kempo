...
**Song Infobox Field Requirements:**

| Field | Requirement | Notes |
|-------|-------------|-------|
| Title | **Required** | Song title |
| Artist | **Required** | Link to performer |
| Released | **Required** | Release year |
| Genre | Recommended | Musical genre |
| Album | Optional | Link to album if applicable |
| Label | Optional | Record label |
| Length | Optional | Duration in M:SS format |
...
**Album Infobox Field Requirements:**
...
| Released | **Required** | Release year |
| Genre | Recommended | Musical genre |
| Label | Recommended | Record label |
| Length | Optional | Total duration |
