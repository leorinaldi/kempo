...
**Timeline Frontmatter Requirements:**

| Field | Requirement | Notes |
|-------|-------------|-------|
| title | **Required** | "YEAR k.y." or "YEARs k.y." |
| slug | **Required** | Year or decade (e.g., "1950", "1940s") |
| type | **Required** | Always "timeline" |
| subtype | **Required** | "year" or "decade" |
| status | **Required** | "published" |
| tags | **Required** | Include "timeline" and the year/decade |
