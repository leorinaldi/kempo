...
Add to the appropriate timeline page (see [create-timeline](../create-timeline/skill.md)):
...
| kyDateBegin | Start date (required) |
| kyDateEnd | End date (null for point events) |
| eventType | See event types above |
| significance | 1-10 scale (10 = most significant) |
| parentId | Link to parent event (e.g., battle → war) |
