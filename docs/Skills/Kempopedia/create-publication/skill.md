...
| publisherId | Link to publishing Organization |
| frequency | daily, weekly, biweekly, monthly, quarterly, annual, irregular |
| startKyDate | First issue date |
| endKyDate | Final issue (null if ongoing) |
...
| type | Must match series type |
| seriesId | Link to PublicationSeries (optional for standalone) |
| publisherId | Publisher (can override series) |
| kyDate | Publication date |
| coverImageId | Link to cover Image |
| pageCount | Number of pages |
| genre | Content genre |
| volume, issueNumber, edition | For periodicals |
